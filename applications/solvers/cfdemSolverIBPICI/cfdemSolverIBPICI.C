            ...
            #endif
            {
                ...
                #endif
                {
                    ...
                    (
                        ...
                        fvm::laplacian(rUA, p) == fvc::div(phi) + particleCloud.ddtVoidfraction() -fvc::div(Fs)*rUA
                    );
                ...
                Fs = 0*Fs;
                particleCloud.setFs(U, Fs, rUA);
                U -= rUA*Fs;
                U.correctBoundaryConditions();
                FInertial = (U - U_Prev)/rUA;
            }            
            U_Prev = U;
        } //end solveFlow
